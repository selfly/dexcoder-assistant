...
//    private boolean unresolvedCacheRef;
    ...
    public void setCurrentNamespace(String currentNamespace) {
        if (currentNamespace == null) {
            throw new AssistantException("The mapper element requires a namespace attribute to be specified.");
        }

        if (this.currentNamespace != null && !this.currentNamespace.equals(currentNamespace)) {
            throw new AssistantException("Wrong namespace. Expected '"
    ...
    public String applyCurrentNamespace(String base, boolean isReference) {
        ...
        if (isReference) {
            ...
            if (base.contains(".")) {
                throw new AssistantException("Dots are not allowed in element names, please remove it from " + base);
            }
        }
