...
//           DocUtils.toStringFromDoc(source.getOwnerDocument()) ;
    ...
    private Node findSqlFragment(String refid) {
        ...
        try {
            ...
            throw new AssistantException("Could not find SQL statement to include with refid '" + refid + "'", e);
        }
    }
        ...
        for (int i = 0; i < children.getLength(); i++) {
            ...
            if (n.getNodeType() == Node.ELEMENT_NODE) {
                ...
                if (originalValue != null) {
                    throw new AssistantException("Variable " + name + " defined twice in the same include definition");
                }
            }
        }
