...
public class RunBinderInterceptor implements MethodInterceptor {
    ...
    public Object invoke(MethodInvocation invocation) throws Throwable {
        ...
        LOG.debug("start:[class={},method={},startTime={}]", new Object[] { targetClass,
                targetMethod, startTime });
        ...
        LOG.debug("finished:[class={},method={},finishTime={}]", new Object[] { targetClass,
                targetMethod, finishTime });

        long useTime = finishTime - startTime;

        if (useTime > LOG_TIMEOUT) {

            LOG.warn("Long processing time:[class={},method={},used time={}]", new Object[] {
                    targetClass, targetMethod, useTime });
        }
        return result;
    }
}
