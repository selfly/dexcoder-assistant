...
//import com.dexcoder.jdbc.utils.*;
...
//        sql.append(" VALUES ");
//        sql.append(args);
//        return new SpringJdbcBoundSql(sql.toString(), pkName, params);
//    }
//
//    /**
//     * 构建更新sql
...
//                    throw new JdbcAssistantException("主键值不能设为空");
//                }
...
//        }
//        return new SpringJdbcBoundSql(sql.toString(), primaryName, params);
//    }
//
//    /**
...
//            }
//        }
//        return new SpringJdbcBoundSql(sql.toString(), null, params);
//    }
//
//    /**
//     * 构建根据主键删除sql
...
//        return new SpringJdbcBoundSql(sql, pkName, params);
//    }
//
//    /**
//     * 构建删除sql
...
//
//        if (sb.length() < 11) {
//            sb.append(boundSql.getPkName()).append(" DESC");
//        }
...
//        }
//
//        return new SpringJdbcBoundSql(countSql.toString(), null, params);
//    }
//
//    /**
//     * 构建查询的列sql
